...
const STATUS_CONFIGS: Record<string, Record<string, StatusConfig>> = {
  ...
  document: {
    ...
    issued: { label: 'Issued', variant: 'default', className: 'bg-blue-100 text-blue-800 border-blue-200' },
    cancelled: { label: 'Cancelled', variant: 'destructive' },
    partially_received: { label: 'Partial', variant: 'secondary', className: 'bg-sky-100 text-sky-800 border-sky-200' },
    partially_paid: { label: 'Partially Paid', variant: 'secondary', className: 'bg-sky-100 text-sky-800 border-sky-200' },
    ...
    accepted: { label: 'Accepted', variant: 'default', className: 'bg-emerald-100 text-emerald-800 border-emerald-200' },
    rejected: { label: 'Rejected', variant: 'destructive' },
    expired: { label: 'Expired', variant: 'outline', className: 'bg-gray-100 text-gray-600 border-gray-200' },
    converted: { label: 'Converted', variant: 'default', className: 'bg-indigo-100 text-indigo-800 border-indigo-200' },
    paid: { label: 'Paid', variant: 'default', className: 'bg-emerald-100 text-emerald-800 border-emerald-200' },
