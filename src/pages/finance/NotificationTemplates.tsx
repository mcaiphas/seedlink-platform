...
const TRIGGER_EVENTS = [
  'invoice_due', 'invoice_overdue', 'payment_received', 'statement_generated',
  'order_confirmed', 'order_shipped', 'quote_sent', 'welcome',
  'password_reset', 'low_stock', 'approval_required', 'manual',
];
