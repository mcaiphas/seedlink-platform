...
export default function KnowledgeDocumentList() {
  return (
    <AdminPage>
      <AdminListPage title="Knowledge Documents" tableName="knowledge_documents" searchPlaceholder="Search documents..." searchFields={['title']}
        columns={[
          { label: 'Title', key: 'title', sortable: true, render: r => <span className="font-medium">{r.title}</span> },
          { label: 'Access Level', key: 'access_level', render: r => <Badge variant="secondary">{r.access_level}</Badge> },
