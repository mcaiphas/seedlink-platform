...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_customers_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_addresses_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_discounts_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_carts_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_cart_items_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_checkout_sessions_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_orders_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_order_items_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_payments_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_inventory_reservations_set_updated_at
...
do $$
begin if not exists (select 1 from pg_trigger where tgname = 'trg_subscriptions_set_updated_at
