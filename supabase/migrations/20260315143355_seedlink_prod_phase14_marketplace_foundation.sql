...
create trigger trg_marketplace_buyer_requests_updated_at
...
create trigger trg_marketplace_trades_updated_at
before update on public.marketplace_trades
for each row
execute function public.set_updated_at();

create trigger trg_marketplace_settlements_updated_at
before update on public.marketplace_settlements
for each row
execute function public.set_updated_at();

create trigger trg_marketplace_payouts_updated_at
