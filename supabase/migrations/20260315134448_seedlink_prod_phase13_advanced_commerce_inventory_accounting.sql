...
create trigger trg_depot_zones_updated_at
before update on public.depot_zones
for each row
execute function public.set_updated_at();

create trigger trg_storage_bins_updated_at
...
create trigger trg_pick_waves_updated_at
...
create trigger trg_fulfillment_batches_updated_at
