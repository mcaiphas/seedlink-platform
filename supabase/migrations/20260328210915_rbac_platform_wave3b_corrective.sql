...
using (
  public.is_admin()
  or public.current_user_has_permission('cart_items:view'::text, null::uuid)
);
...
with check (
  public.is_admin()
  or public.current_user_has_permission('cart_items:create'::text, null::uuid)
);
...
using (
  public.is_admin()
  or public.current_user_has_permission('cart_items:update'::text, null::uuid)
)
with check (
  public.is_admin()
  or public.current_user_has_permission('cart_items:update'::text, null::uuid)
...
using (
  public.is_admin()
  or public.current_user_has_permission('cart_items:delete'::text, null::uuid)
);
