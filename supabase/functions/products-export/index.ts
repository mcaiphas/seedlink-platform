...
serve(async (req) => {
  ...
  try {
    ...
    const headers = Object.keys(rows[0] ?? {
      ...
      price: "", compare_at_price: "", currency_code: "", stock_quantity: "", status: "",
      base_uom: "", shipping_weight_kg: "", image_url: "", barcode: "", handle: "",
      external_id: "", shopify_product_id: "", shopify_variant_id: "",
    });
